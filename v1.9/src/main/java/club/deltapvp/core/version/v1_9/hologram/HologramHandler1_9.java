package club.deltapvp.core.version.v1_9.hologram;
...
public class HologramHandler1_9 extends AbstractHologramHandler {
    ...
    public HologramHandler1_9(DeltaPlugin plugin) {
        this.plugin = plugin;
