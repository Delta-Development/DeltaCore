...
package club.deltapvp.core.version.v1_16.hologram;
...
public class HologramHandler1_16 extends AbstractHologramHandler {
    ...
    public HologramHandler1_16(DeltaPlugin plugin) {
        this.plugin = plugin;
