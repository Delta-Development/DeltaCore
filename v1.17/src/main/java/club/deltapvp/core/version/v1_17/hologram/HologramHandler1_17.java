...
public class HologramHandler1_17 extends AbstractHologramHandler {
    ...
    public HologramHandler1_17(DeltaPlugin plugin) {
        this.plugin = plugin;
    ...
    public void update(Player player, Hologram hologram, boolean all) {
        ...
        for (EntityArmorStand armorStand : entities) {
            ...
            if (!all)
                ...
                onlinePlayers.forEach(p -> ((CraftPlayer) p).getHandle().b.sendPacket(packet));
        }
